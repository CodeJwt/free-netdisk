...
CREATE TABLE `file_recycle`  (
  ...
  `file_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '关联fileId',
  ...
  `clear_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '自动清理时间',
	status tinyint(1) NOT NULL DEFAULT 0 COMMENT '文件状态（0-正常，1-已恢复或彻底删除）',
  PRIMARY KEY (`recycle_id`) USING BTREE,
	INDEX delete_user_id (delete_user_id) USING BTREE
...
CREATE TABLE `file_user`  (
  ...
  `file_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件名称',
  `file_logical_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件逻辑路径（页面展示的路径）',
  `file_size` int(11) NOT NULL DEFAULT 0 COMMENT '文件大小',
  `dir` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否为文件夹（0-是，1-不是）',
  `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户id',
  `parent_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '父文件夹id(0为顶层目录)',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '文件状态（0-正常，1-已删除，2-已隐藏）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
CREATE TABLE `user`  (
  ...
  `password` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '密码',
  ...
  `total_memory` bigint(20) NOT NULL DEFAULT 5242880 COMMENT '网盘总容量',
  `base_memory` bigint(20) NOT NULL DEFAULT 5242880 COMMENT '基础容量（随等级变化）',
...
CREATE TABLE `user_join`  (
  ...
  `join_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '参与活动时间',
  `activity_memory` bigint(20) NOT NULL DEFAULT 0 COMMENT '活动赠送容量',
  `memory_time` int(11) NOT NULL DEFAULT 7 COMMENT '容量有效时间（天）',
...
CREATE TABLE `user_share`  (
  ...
  `is_public` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否公开（公开不需要密码）0-公开，1-不公开',
  `is_forever` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否永久（0-永久，1-不永久）',
  `share_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '分享时间',
  `end_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '过期时间',
  ...
  INDEX `share_user_id`(`share_user_id`) USING BTREE
...
)ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户分享详情表';
...
CREATE TABLE `user_transfer`  (
  ...
  `file_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件名称',
	`file_ext_name` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '文件扩展名',
  `file_size` int(11) NOT NULL DEFAULT 0 COMMENT '文件大小',
  `file_logical_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '页面展示的路径（对应上传）',
  ...
  `transfer_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '传输时间',
